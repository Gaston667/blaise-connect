...
| US | Deadline | Nom de l’US | Description de l’US | Statut | Fichiers concernés |
|---|---|---|---|---|---|
| US-017 | 18/08/2026 | Saisie des appréciations | En tant qu’enseignant, je veux ajouter une appréciation sur le travail d’un élève afin de compléter ses résultats et son bulletin. | À tester | `database/migration/006_report_cards_year_deletion.sql`, `backend/app/routes/appreciations.py`, `backend/app/services/appreciation_service.py`, `frontend/src/pages/appreciations_page.jsx` |
