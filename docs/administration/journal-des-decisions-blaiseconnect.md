...
| D-011 | 26/07/2026 | Co-enseignement | Plusieurs enseignants pouvaient être affectés simultanément à la même matière d'une même classe. | ⬜ Remplacée par D-031 |
...
| D-016 | 26/07/2026 | Coefficients des matières | L'administrateur configure `class_subjects.coefficient` pour chaque matière d'une classe. Le coefficient est strictement positif ; l'arrondi des moyennes est fixé à deux décimales. | 🟩 Validée |
...
| D-028 | 30/07/2026 | Fusion des migrations | Les 8 migrations initiales avaient été fusionnées en 5 fichiers cohérents. Cette organisation historique est remplacée par la séquence à 6 fichiers de D-034. | ⬜ Remplacée par D-034 |
...
| D-031 | 02/08/2026 | Enseignant unique par matière de classe | Une matière d'une classe ne peut avoir qu'un seul enseignant sur une même plage de dates. L'interface affiche les matières déjà affectées en grisé et PostgreSQL interdit les chevauchements, même entre enseignants différents. Cette décision remplace D-011. | 🟩 Validée |
| D-032 | 03/08/2026 | Absence à une évaluation | Une absence reste enregistrée avec `result_type = 'ABSENT'` et `score = NULL`. Si elle est justifiée, elle est exclue de la moyenne ; si elle est non justifiée ou rejetée, le calcul lui applique zéro. Un statut en attente bloque la validation du bulletin. | 🟩 Validée |
| D-033 | 03/08/2026 | Stockage documentaire | Les fichiers restent hors de PostgreSQL. `document_types` définit un catalogue extensible, `documents` conserve les métadonnées et les tables de liaison rattachent les justificatifs aux notes ou aux incidents d'assiduité. Les PDF de bulletins référencent également `documents`. | 🟩 Validée |
| D-034 | 03/08/2026 | Sept migrations principales | Le schéma d'initialisation est consolidé dans sept migrations : accès, comptes/profils, relations/documents, structure scolaire, activité pédagogique, bulletins/suppression auditée d'une année ouverte, puis emploi du temps. Les ajouts d'assiduité, de nationalité et de créneaux datés sont intégrés à ces migrations principales. | 🟩 Validée |
| D-035 | 03/08/2026 | Modèle d'appel | `attendance_events` prouve qu'un appel a été effectué pour un cours. Seuls les élèves absents ou en retard figurent dans `attendance_records`; un élève inscrit sans incident est considéré présent. | 🟩 Validée |
| D-036 | 07/08/2026 | Configuration de l'emploi du temps | Les horaires et pauses sont réglés par année, cycle et jour. Le volume hebdomadaire est défini par année, niveau et matière. L'algorithme produit une version `DRAFT`, validée ensuite par l'administrateur. Les cours particuliers restent individuels. | 🟩 Validée |
| D-037 | 14/08/2026 | Nationalité et inscription élève | La nationalité est obligatoire lors de la création de tout nouveau profil. Un élève archivé est automatiquement désinscrit de sa classe avec le motif `LEFT_SCHOOL`; l'historique de son inscription est conservé. | 🟩 Validée |
| D-038 | 16/08/2026 | Rang et moyenne de classe du bulletin | À l'affichage, le rang et les moyennes de classe sont calculés parmi la dernière version générée des bulletins de la même classe et de la même période. Ils ne sont pas encore stockés comme instantanés historiques. | 🟩 Validée |
| D-039 | 22/08/2026 | Informations complémentaires de l'élève | Le dossier élève conserve facultativement l'établissement précédent, une maladie particulière et l'inscription au CNED. La donnée médicale n'est consultable que par les administrateurs et enseignants ; elle n'est pas exposée aux espaces élève et responsable légal. | 🟩 Validée |
| D-040 | 22/08/2026 | Créneaux datés et plage de génération | La saisie manuelle crée un cours unique avec une date et des heures précises dans `timetable_date_slots`. La génération automatique reçoit une plage de dates incluse dans l'année scolaire. Les créneaux hebdomadaires récurrents de `timetable_slots` restent utilisés par le générateur ; l'affichage présente une semaine avec les dates réelles. | 🟩 Validée |
| D-041 | 22/08/2026 | Report de l’US-017 | Les appréciations préparatoires par les enseignants sont retirées de la version actuelle : pas de page, route, service ou table de brouillon. Les champs historiques du bulletin sont conservés pour une future réalisation validée. | 🟩 Validée |
