  ...
  async function handleSubmit(e) {
    ...
    try {
      const payload = {
        ...
        enrollment_start_date: form.class_id
    ...
    <div className="asm-overlay" onClick={onClose}>
      <div className="asm-modal" onClick={(e) => e.stopPropagation()}>
        <div className="asm-header">
          ...
          <button type="button" className="asm-close" onClick={onClose}>
            ✕
          </button>
        </div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  const year = schoolYears.find(
                    (y) => y.id === selectedClass?.school_year_id,
                  );
                  setForm((f) => ({
                    ...f,
                    class_id: newClassId,
                    enrollment_start_date:
                      year?.start_date ?? f.enrollment_start_date,
                  }));
                }}
              >
          ...
          {form.class_id && (
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  update("enrollment_start_date", e.target.value)
                }
              />
            </label>
          )}
