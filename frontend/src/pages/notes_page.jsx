...
export default function NotesPage({ account, onNavigate, initialAssessmentId }) {
  ...
  return (
    <main className="ntp-main">
      <div className="ntp-topbar"><div><h1 className="ntp-title">Gestion des évaluations et des notes</h1><nav className="ntp-breadcrumb" aria-label="Fil d’Ariane"><button type="button" onClick={handleHomeNavigation}>Accueil</button><span>›</span><span>Notes</span></nav><p className="ntp-subtitle">Créez les évaluations puis saisissez les résultats de tous les inscrits.</p></div><div className="ntp-topbar-actions"><button type="button" className="ntp-btn-primary" onClick={openAssessmentModal}><Plus size={16} /> Créer une évaluation</button></div></div>
